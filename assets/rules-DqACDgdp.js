import"./modulepreload-polyfill-B5Qt9EMX.js";import{$ as e}from"./vendor-CeA792Xf.js";import{c as o}from"./client-C7Xh_emp.js";import{p as a}from"./news-CdsrJnaW.js";const t=[{date:1731370468e3,author:"hasanger",title:"Rules",content:"By playing Suroi, you agree to follow these rules. Failure to do so will result in a ban, as outlined below.",longContent:`
        <br>
        <h2>No hacking!</h2>
        ...
        `},{date:169090823e4,author:"Katloo",title:"Tutorial",content:"If you're a new player, check out this tutorial to learn how to play!",longContent:`<h2>Controls</h2>
...
`}];e(()=>{o("#splash-more"),e("#news-articles").html(t.map(a).join(""))});
