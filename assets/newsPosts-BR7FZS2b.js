const e=[{date:1731370468e3,author:"HAZEL",title:"空篮子",content:`Harvest 即将结束，经典模式重返岛上，但更多即将到来。我们将在不久的将来<strong>对帐户进行封闭测试</strong>，因此请继续关注 Suroi 官方频道以获取有关如何参与的信息。

<br><a href="/rules">规则</a>已更新。请花时间阅读它们。`},{date:1730689557e3,author:"HAZEL",title:"秋枯",content:"诡异的季节结束了，Plumpkins 已经死了。我们希望您喜欢今年的万圣节模式，并将在未来的活动中考虑您的反馈。采摘将持续到 <strong>11 月 11 日</strong>，但未来将以轮换模式回归。"},{date:1730428409e3,author:"HAZEL",title:"普朗普金恐慌",bannerImage:"../img/news/v0.21.0.png",content:`<strong>万圣节快乐！</strong>又到了一年中的那个时候，Plumpkins 已经冲出了地堡，让岛上充满了全新的特权机会。Harvest 地图已更改以适应庆祝活动，具有令人愉悦的诡异主题。

<br><br>在有限的时间内，除了普通特权外，还将提供 <strong>13 个全新的万圣节专属特权</strong>。无需在两者之间进行选择：您可以各自拥有一个！

<br><br>万圣节将持续 <strong>3 天</strong>，直到美国东部标准时间 11 月 3 日晚上 8 点。`,longContent:`<h2>Suroi v0.21.0</h2>
<h3>新功能</h3>
<ul>
<li><strong>万圣节模式！</strong>Harvest 模式的变体，带有一些令人毛骨悚然的好东西。</li>
<li><strong>更多福利！</strong>添加了 13 个万圣节独有的特长。</li>
</ul>

<h3>变化</h3>
<ul>
<li>增强了 89 型和 DT-11。</li>
<li>对 SKS 精灵进行了轻微调整。</li>
<li>修复了团队 ping 在空投降落伞下方渲染的问题。</li>
  </ul>`},{date:1730057509e3,author:"HAZEL",title:"开放季",bannerImage:"../img/news/v0.20.0.png",content:`秋天选择了一种全新的模式 <strong>Harvest</strong>，带来了大量的<strong>新枪支</strong>、各种各样的 <strong>Perks</strong> 和神秘的 <strong>Plumpkins......</strong>

<br><br>Harvest 是一张大地图，充满了新的树木、小径和全新的环境声音和粒子，以及大量的新结构，包括<strong>谷仓</strong>、有大量掩护的古老农业遗迹，以及 <strong>Lodge</strong>，一个豪华的森林度假胜地，拥有更多眼前所见......

<br><br>在地下深处，<strong>Plumpkin Bunker</strong> 已被发现。这座工程和科学的纪念碑包含了从储备充足的警卫宿舍到仓库、发电机房和主要实验室本身的一切。有传言说，密封在测试室内的实验非常神秘，但对于任何有幸亲身体验的人来说，都会<strong>获得丰厚的回报</strong>。其中一个样本似乎被密封了......<strong>就目前而言。</strong>

<br><br>最近的文件显示，<strong>被炸毁的军械库</strong>里有封印在金库内的回归粉丝最喜欢的 <strong>USAS-12</strong>，尽管这次进入可能需要更<strong>蛮力</strong>的方法。

<br><br>Harvest 和 Normal 模式的全新武器包括 <strong>SKS</strong>，这是一种可靠且常见的 DMR，采用 7.62 装腔，尽管它在损坏方面还有待改进。<strong>VKS Vykhlop</strong> 的覆盖范围不止于此，它以低速发射高伤害抑制的 .50 cal 子弹。最后，巨大的 <strong>Mk-18 雷神之</strong>锤，装在 .338 Lapua Magnum 中，将以令人印象深刻的巨大伤害和快速射速的组合撕裂任何比赛。

<br><br>Harvest 模式的独特之处在于两把全新的霰弹枪，<strong>DT-11</strong>，一种下置双管霰弹枪，与锯断的同类相比，射程更远，伤害更低，以及 <strong>M590M</strong>，一种发射高爆弹头的军用泵动式霰弹枪。

<br><br>还有更多内容可供查看，包括新皮肤、各种小型结构、全新的树叶以及即将到来的变化。
